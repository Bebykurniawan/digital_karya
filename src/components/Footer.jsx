    ...
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex-col flex justify-start mr-10">
        ...
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          A new way to make the website modern, responsive and secure.
        </p>
          </div>
        <div className="w-full flex flex-row justify-between flex-[1.5] flex-wrap md:mt-0 mt-10">
            ...
            >
              ...
              <ul className="list-none mt-4">
                {footerLink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-poppins text-[16px] font-normal leading-[24px] text-dimWhite hover:text-secondary cursor-pointer 
...
<p className="font-poppins font-normal text-[18px] leading-[27px] text-white">2024 DigitalKarya. All Right Reserved.</p>
